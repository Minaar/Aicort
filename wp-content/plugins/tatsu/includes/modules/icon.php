...
if (!function_exists('tatsu_icon')) {
	function tatsu_icon( $atts, $content, $tag ) {
		...
		$output .= '<a href="'.$href.'" class="tatsu-icon-wrap '.$style.' '.$animate.' '.$mfp_class.' '.$hover_effect_child.' '.$gdpr_concern_selector. ' ' . $ripple_class . '" '.$data_animations.' data-gdpr-atts='.$gdpr_atts.' '.$new_tab.'>';
